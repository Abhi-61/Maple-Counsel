...
To deliver strong economic outcomes, the program focuses its priorities on three core objectives: care, build and innovate.
...
To see which workers may benefit from targeted invitations to apply, see the Care section of the BC PNP's selection of workers list.
...
To see which workers may benefit from targeted invitations to apply, see the Build section of the BC PNP's selection of workers list.

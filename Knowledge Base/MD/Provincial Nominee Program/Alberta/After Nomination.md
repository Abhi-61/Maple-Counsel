# Alberta Opportunity Stream – After you are nominated

After your AAIP nomination is accepted, you may apply for permanent residence or to extend your work permit or nomination.
...
AAIP may extend your nomination. Read the information below on how to extend your nomination.
You must keep the AAIP and the Immigration, Refugees and Citizenship Canada (IRCC) updated on changes to your personal circumstances.
...
AAIP may withdraw your nomination at any time if you no longer meet the conditions of nomination or if you provided false or misleading information in your AAIP application.
## Apply for permanent residence

Step 1. Review your nomination package
Your AAIP nomination certificate is available under the “View Decision Letters” in the AAIP portal. If you have an authorized representative, notify them of the decision on your application.

Read everything in the package carefully.

Update your information through the “Update Employment Information” tab in your AAIP portal. If you find mistakes on your nomination certificate, highlight all errors on the nomination certificate and upload a PDF copy of the corrected certificate via your AAIP portal. AAIP will not accept update requests sent by email.
...
After you get your AAIP nomination, you must apply to IRCC as soon as possible. Your nomination is only valid for 6 months; you must apply to IRCC before it expires. You may qualify to have your AAIP nomination extended. A $150 fee applies for all requests for nomination extensions.

The sooner you apply for permanent residence, the sooner you can get an Acknowledgement of Receipt (AOR) of your application from IRCC and your IRCC file number. Your AOR and IRCC file number are very important if you need to extend your work permit.

Visit the IRCC website to get all the information you need to apply for permanent residence.

Note: IRCC will not accept your application if it is incomplete or you have not paid the required fees.
...
AAIP does not have any information about your IRCC application and cannot provide status updates.
...
If there are changes to the following information while IRCC is processing your permanent residence application, you must contact both AAIP and IRCC:
...
Provide AAIP application updates through the AAIP portal.

### Online application using the AAIP portal

Note: All responses to requests for information, updates of your contact information (except email address), employment and family information and changes to your representative must be completed in the portal. Withdrawals must also be completed in the AAIP portal.

If you need to change your email address for corresponding with the AAIP, you must update your Alberta.ca Account.

Ensure you attach all relevant documents. You must keep track of the changes you send to AAIP. AAIP will update its internal system with changes.

### Forms to notify AAIP of updates

A signed Use of Representative form must be provided to change your third-party representative for your AAIP application
Complete the online request
To respond to requests for information, withdraw an application, update your contact information (excluding email address), family information, employment information and representative:

Log into the AAIP portal
On the portal main page, select 'Create New Request'.
Find the AAIP application number for the application that you want to update existing contact information.
Once you select the application number, you will be directed to a page with detailed information. You can only see request options that are available to you for this application.
...
Update employment information: You can update your current employment information for all active or nominated applications. Use this option to provide responses to information requests, reference letters, LMIAs, work permits, job offers, employment contracts, pay records, Records of employment and licensing or certification documents.
...
Respond to requests for information: All responses to information requests must be saved in a Word or PDF format and uploaded via the “Update Employment Information” tab in your AAIP portal. Documents related to the request for information should be uploaded via the portal. Responses sent by email could delay processing of your application.
...
Select the blue button for the type of request or update you want to submit.
...
Update contact information: The contact information AAIP currently has for you is provided. To update your address or phone number, replace the existing information with your new information. Only update the information that is no longer correct. Do not delete any information that is still correct. Include only your contact information. Do not provide anyone else’s information, including that of your third-party representative.
...
AAIP will review your request to withdraw and will notify you by email after the review is completed.
...
AAIP recommends that you first explore option 1, 2 or 3.
...
- have an Acknowledgement of Receipt (AOR), and
- can meet all other IRCC work permit and status requirements
- Follow these steps when applying for the Bridging Open Work Permit:

Include a copy of your AAIP nomination when you apply.
Include a copy of your AOR from IRCC with your IRCC file number.
...
If Options 1, 2 or 3 are not available to you, you may be eligible to receive a 204(c) Letter of Support from AAIP to renew your work permit.

All nominees who had a valid work permit at the time of nomination, must submit a request to be considered for a 204(c) Letter of Support. AAIP will review your request and determine if a letter can be issued.

There is no guarantee a 204(c) Letter of Support will be issued.

AAIP will only issue one 204(c) Letter of Support per nominee. A second 204(c) Letter of Support may be issued to nominees who have a written request from IRCC for a 204(c) Letter of Support.

The following processes and considerations apply to requests for a 204(c) Letter of Support:

All nominees must complete and submit a request for 204(c) Letter of Support. How you submit the request depends on how you applied to AAIP (mail or online application). You cannot submit a request for a 204(c) Letter of Support until you have received a nomination certificate.
All requests for a 204(c) Letter of Support are subject to a service fee of $150. Exception: Nominees who have a written request from IRCC for a 204(c) Letter of Support do not need to pay the service fee.
...
All requests for a 204(c) Letter of Support are subject to a service fee of $150.
...
Instructions on how to pay your fee are available in the portal. For any online fee payment issues, contact eServices.
...
Check the Request Status of your application on the Check Existing Requests page to confirm if your request fee has been paid.

If the status is 'Payment Pending', your fee has not been paid.
If the status is 'Submitted', your request is being processed. eServices will send an email with a paid receipt.
### After you submit a request for a 204(c) Letter of Support

To view the status of your 204 (c) Letter of Support request, log into the AAIP portal, and select “Check Existing Request”.

If you receive a written request from IRCC for a 204(c) Letter of Support, AAIP will attempt to respond to your request by the deadline provided by IRCC.

The online request and supporting documents will be reviewed. You will receive an email notifying you if the request meets the conditions required for a 204(c) Letter of Support to be issued.
...
Note: All requests for a nomination extension are subject to a service fee of $150. Information on how to pay the fee is provided below.
...
You must apply to IRCC before your nomination expires. If your nomination expires and you request an extension, the reasons why you need an extension will be reviewed by AAIP.
...
AAIP must receive your extension request within 6 months of the expiry date of your original Nomination. If more than 6 months have passed since the expiry date of your original Nomination, you are not eligible for an AAIP Nomination extension.
Exception: If you applied for permanent residence before your nomination expired and were impacted by IRCC’s processing delays, you can submit a request more than 6 months after your nomination’s expiry date. You must explain your situation in your request and provide proof that you applied for permanent residence before your nomination certificate expired.
You must continue to meet all of the conditions that were in place at the time your original nomination was issued by AAIP.
Full fee payment must be received. Requests will not be processed until full payment is received.
AAIP will not respond to any inquiries about the status of your nomination extension request. You can log onto the AAIP portal to view the status of your request.

## Request a nomination extension

### Online application using the AAIP portal

Candidates who submitted their application online using the AAIP portal must submit their request for nomination extension using the portal.
...
Select the blue 'Request Nomination Extension' button.
Next, read the Protection of Privacy Act (POPA) clause and other important information about completing a request. Check off the box and click on 'Continue'. A draft is automatically saved once you click on the 'Continue' button. If you experience any technical issues or leave the request section while creating the request, you will need to go to the 'Check Existing Requests' page to retrieve the draft request to continue.
Fill out the form, complete the online declaration and upload supporting documents, if applicable, and select 'Submit Request' button.
Next you must pay the fee.
### Step 2. Pay the fee

All requests for nomination extension are subject to a service fee of $150.

### Fee conditions

The request for a nomination extension fee is non-refundable once a request has been submitted to AAIP. Refund requests for nomination extensions will not be considered. The fee covers the cost of processing of your request and is required whether a nomination extension is issued or not.

### Online payment

Instructions on how to pay your fee are available in the portal. For any online fee payment issues, contact the eServices.

You will need to pay your fee in full within 24 hours of submitting your request in the portal. If you do not pay your fee within 24 hours of submitting your request, your request will be cancelled. Cancelled requests cannot be reinstated and a new request must be created and submitted.

Check the request status of your application on the 'Check Existing Requests' page to confirm your request fee has been paid.

If the status is 'Payment Pending', your fee has not been paid.
If the status is 'Submitted', your request is being processed. eServices will send an email with a paid receipt.
### After you request an extension

Your request and supporting documents will be reviewed. You will receive an email notifying you if the request meets the conditions required for a nomination extension to be issued.

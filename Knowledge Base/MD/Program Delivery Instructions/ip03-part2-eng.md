...
| Humanitarian Asylum Class Country | Under joint assistance sponsorship |
| CRS | Privately sponsored refugee admitted to Canada |
| under cost-sharing/blended initiatives are also eligible to receive prescribed RAP income support based on specific initiatives set out by the Department. | Must not be special needs case |
...
Month 1: initial payment cheque
Month 2: pro-rated move adjustment
Months 3 to 11
Month 12
Year 2
School start-up
For more information
Month 1 (initial payment cheque - full monthly income support plus start-up allowances)
...
Government of Canada cheques (until a client is on Direct Deposit)
Direct deposit (should be initiated as soon as possible)
Priority cheques (in emergencies)
...
Note: Additional income earnings in months where income support is not received (e.g., time spent in temporary accommodations, or for months where RAP is already reduced to $0) are not subject to deductions, however all earnings still need to be reported in order to confirm exemption.

For months where earnings are identified and RAP income support was issued, adjustments are deducted from a following month’s entitlement. Should repayment cause hardship, deductions may be staggered over a number of months. Seasonal or irregular payment periods, where clients are not paid for their earnings within a monthly period, should be considered on a case-by-case basis on the best approach to calculate earning exceptions, with approval from the IRCC RAP supervisor/manager, and consultation with NHQ-IN-ROD as required.
...
Note: The 50% threshold is calculated from the total monthly amount the family would receive prior to any adjustments applied from previous overpayment amounts.
...
### Guidelines for RAP income support eligibility assessment
...
The 50% additional income threshold and personal asset maximums for OYW cases
One Year Window (OYW) move allowance
### Guidelines for RAP income support eligibility assessment
...
receiving RAP income support
receiving provincial or territorial social assistance and no longer receiving RAP income support or
employed and no longer receiving RAP income support
...
Serious situations involving legal offences need to be referred to the IRCC local Manager and NHQ-IN-ROD for concurrence on a recommended approach to the situation.
...
Learn about courses of action to take against Fraud.
...
Refer to IRCC’s guardianship protocol and legal guardianship process, including contact information for the authorities responsible for youth protection, in the province where the PA and minor will reside.
For a consanguineous minor joining a relative in Canada, contact the relative to confirm that they understand their responsibilities as guardian of the child once in Canada. Make sure the relative understands that as guardian they will be responsible for the care and protection of the minor until the minor reaches the age of majority in the province in which they reside. Encourage them to secure legal guardianship, letting them know that the RAP officer will be in touch to provide information on how to initiate that process once the child arrives in Canada.
Where necessary, have the relative sign the Immigration Loan form.
Inform the RAP SPO that a consanguineous minor or de facto dependant will be arriving in the province. Provide the RAP SPO with the necessary guardianship information for use during the orientation.
Inform the provincial director of child welfare if a separated minor or a minor who will be resettled with a family member in their province is arriving. Make sure to specify if any concerns for the child’s safety have been raised.
For a consanguineous minor, inform the ROCO and the migration office to proceed with the case, once the blood relative has been contacted
### Arrival of the minor: RAP SPO

Once the PA and/or the minor have arrived, the RAP SPO will do the following:

Remind the PA or relative of their guardianship responsibilities until the minor reaches the age of majority in that province.
Provide the necessary RAP and guardianship information and encourage them to start the legal guardianship process for that province.
### Monitoring or tracking of separated minors: local IRCC

The local IRCC will conduct a monitoring interview with 100% of the cases within 7 months after their arrival. This will include a reminder to the PA or relative of the importance in following through with the guardianship process. Where necessary, the local IRCC will re-supply the PA or relative with the guardianship information and encourage the PA or relative to start the process to obtain legal guardianship.
If there are any concerns regarding the safety of the child, the local IRCC should check the Internet for information on how to report abuse in that province.
The Settlement worker should be made aware of the guardianship issues related to the family and should reinforce the importance of initiating the guardianship process.
...
In some cases, payments for the adult dependant child’s file can continue to be issued under the vendor of the HOF, or another person, such as a guardian, or a financial trustee in the case of a mentally incompetent adult. Some factors that can be considered if the family wishes for the HOF to receive the RAP payments on behalf of the adult dependant child, include the following:
...
Separation or divorce
When a RAP officer becomes aware that a marriage breakdown has occurred, clients should be given the opportunity to provide any information which may affect their ongoing income support. A declaration (such as a signed letter, or statutory declaration) and Change of Status Form should be signed by both clients to confirm that the information in the declaration is mutual and being accurately reported to IRCC. In cases where a signature is difficult to obtain from one of the parties, the RAP officer should work with the SPO to understand the situation, or have documents signed separately.

Income support may be given separately to both parties for the remaining duration of their commitment, if they confirm in writing (such as through a statutory declaration or signed letter) that a separation has occurred and that they are living in separate dwellings, and submit proof of residency, such as a lease. For clients fleeing or residing in a shelter, or where a lease is not available, these situations should be assessed and handled on a case by case basis with the approval of a supervisor/manager or consultation with NHQ IN-ROD, as needed, on income support issued in those scenarios. The spouse who is being removed from the RAP-IS application should be disassociated accordingly, along with any dependents joining their file, where applicable. A new RAP application and vendor for the disassociated spouse would then be created in GCMS, generally starting on the 1st of the month following their separation, but details should be reviewed and treated on a case by case basis due to variables in spousal separations. The spouse for whom a new RAP application is being created would need to sign a new Agreement for Income Support reflecting the new commitment period. The original RAP agreement which was signed can remain valid for the original HOF’s continuation of support for the remainder of their commitment period indicated on the Agreement.
...
An additional start-up payment for certain allowances may be issued in situations where a client lacks the necessary furnishings and household goods following the division of assets.
...
If a single client is to be incarcerated, a re-assessment of their RAP benefits should occur, in consideration of the length of time of their expected incarceration. Consultation with NHQ-IN-ROD may be required, as these cases should be considered on a case-by-case basis.
...
The RAP officer will determine whether or not the rate of assistance is to be affected, based on factors such as

the length of the anticipated hospital stay
the number of members in household
the amount of assistance
ongoing lease and rental obligations
Travel outside of province of residence or Canada
...
Stolen, lost or never-received cheques or direct deposits
...
JAS clients
Secondary migration for BVORs
RAP Services to BVORs
Self-destination
Secondary migration
